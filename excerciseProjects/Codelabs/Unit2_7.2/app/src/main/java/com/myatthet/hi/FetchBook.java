...
public class FetchBook extends AsyncTask<String, Void, String> {
    ...
    public WeakReference<TextView> mTitleText;
    public WeakReference<TextView> mAuthorText;
    public WeakReference<ImageView> imageView;

    // Constructor, provides references to the views in MainActivity.
    FetchBook(TextView titleText, TextView authorText,ImageView imageView) {
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            while (i < itemsArray.length() &&
                    (authors == null && title == null && image ==0)) {
            ...
            if (title != null && authors != null && image !=0 ) {
