...
//    }
    ...
    NavigationIconClickListener(
            ...
            @Nullable int openIconId, @Nullable int closeIconId) {
        this.context = context;
        this.sheet = sheet;
        this.interpolator = interpolator;
        this.openIconId = openIconId;
    ...
    private void updateIcon(View view) {
        ...
        if (backdropShown == false) {
            //branded icon
            ((ImageView) view).setImageResource(openIconId);
        } else {
            //normal icon
            ((ImageView) view).setImageResource(closeIconId);
        }
    }
